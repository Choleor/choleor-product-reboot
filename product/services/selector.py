class ExtractChoreography:
    ...
    def get_music_similarity_score(self, a):
        # self.__similarity_scores_unnormalized = Process().get_similarity_score()
        self._similarity_unnormalized = a
        return a

    def set_song_score(self, song_score):
        # TODO song score 객체 has-a로 갖든.. setting 로직
        self.__song_score = song_score
    ...
    def extract_final_score(self):
        ...
        self.get_music_similarity_score([3, 5, 1])
        self.set_song_score([[3, 5, 6, 8], [4, 10, 1, 5, 10], [3, 1, 5]])
